...
namespace FlowLab.Game.Objects.Layers
{
    internal class SimulationLayer : Layer
    {
        ...
        public override void Update(GameTime gameTime, InputState inputState)
        {
            ...
            Camera2DMover.ControllZoom(gameTime, inputState, _camera, .1f, 1);
            TransformationMatrix = _camera.Update(GraphicsDevice.Viewport.Bounds);
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            _particleManager.DrawParticles(spriteBatch, TransformationMatrix, particleTexture, Color.Gray);
