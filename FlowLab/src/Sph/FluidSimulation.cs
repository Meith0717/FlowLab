...
public class FluidSimulation
{
    ...
    public FluidSimulation()
    {
        ...
        var spatialHashSystem = new SpatialHashSystem3D(
            new(SimulationConfig.SpatialHashQueryRadius)
        );
        _world = new World();
        ...
        for (var j = 0.5f; j < 30.5f; j++)
        {
            ...
            position = new Vector3(i, j, 29.5f);
            ParticleFactory.CreateBoundaryParticle(_world, position);
            position = new Vector3(i, j, 30.5f);
            ParticleFactory.CreateBoundaryParticle(_world, position);
        }
        ...
        for (var j = 0.5f; j < 30.5f; j++)
        {
            ...
            position = new Vector3(29.5f, i, j);
            ParticleFactory.CreateBoundaryParticle(_world, position);
            position = new Vector3(30.5f, i, j);
            ParticleFactory.CreateBoundaryParticle(_world, position);
        }
        AddBlueParticle();
    }
